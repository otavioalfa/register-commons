...
public class Erro400 {
    ...
    public Erro400(Integer codigo, String mensagem) {
        this.codigo = codigo;
        this.mensagem = mensagem;
    }

    public Erro400(Integer codigo, String mensagem, Erro erros) {
        this.codigo = codigo;
        this.mensagem = mensagem;
        this.addErrosItem(erros);
    }

    public Erro400(MensagemEnum mensagemEnum, Erro erro) {
        this.codigo = mensagemEnum.getId();
        this.mensagem = mensagemEnum.getDescription();
        this.addErrosItem(erro);
    }

    public Erro400(Integer codigo, String mensagem, List<Erro> erros) {
        this.codigo = codigo;
        this.mensagem = mensagem;
        this.erros = erros;
    }

    public Erro400 codigo(Integer codigo) {
        this.codigo = codigo;
        return this;
    }
    ...
    public Erro400 mensagem(String mensagem) {
        this.mensagem = mensagem;
        return this;
    }
    ...
    public Erro400 erros(List<Erro> erros) {
        this.erros = erros;
        return this;
    }

    public Erro400 addErrosItem(Erro errosItem) {
        if (this.erros == null) {
    ...
    public Erro400 devolutivas(List<Devolutiva> devolutivas) {
        this.devolutivas = devolutivas;
        return this;
    }

    public Erro400 addDevolutivasItem(Devolutiva devolutivasItem) {
